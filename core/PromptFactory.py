...
class PromptFactory:
    ...
    def build_table_identification_prompt() -> PromptTemplate:
        ...
        """
        prompt: str = (
            PromptFactory.get_helpful_assistant_prefix()
    ...
    def build_final_response_prompt() -> PromptTemplate:
        ...
        """
        prompt = (
            PromptFactory.get_personal_response_prefix()
    ...
    def build_select_query_for_top_three_rows() -> PromptTemplate:
        ...
        """
        prefix = PromptFactory.get_cql_code_gen_prefix()
        prompt = (
            prefix
    ...
    def build_select_query_with_where() -> PromptTemplate:
        ...
        """
        prompt = (
            PromptFactory.get_select_query_with_where_text()
            + """
        {TableSchema}
    ...
    def determine_failure_type() -> PromptTemplate:
        ...
        """
        prefix = PromptFactory.get_helpful_assistant_prefix()
        prompt = (
            prefix
    ...
    def build_example_insert_statements() -> PromptTemplate:
        prompt = (
            PromptFactory.get_helpful_assistant_prefix()
            + " Based on the given business description and "
    ...
    def build_questions_from_user_summary() -> PromptTemplate:
        prompt = (
            PromptFactory.get_helpful_assistant_prefix()
            + "I will give you a summary of what we know about a customer's interactions with my business, and I have a lot "
            "of information that might be helpful for them. I want you to formulate a list of example questions that are "
            "representative of what the customer might might want answered from our public documentation. Focus questions on "
            "topics that are most relevant to their current question. Return the list of questions as a valid JSON array. "
            ""
            "Here is the summary:"
            ""
            "{CustomerSummary}"
            ""
            ""
            "The customer's current question is:"
            "{CustomerQuestion}"
        )
